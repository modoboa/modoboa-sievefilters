...
def fset_menu(mode, setname):
    ...
    if mode == "gui":
        entries += [
            {"name": "newfilter",
             "img": "fa fa-plus",
             "label": _("New filter"),
             "url": reverse("modoboa_sievefilters:filter_add",
                            args=[setname]),
             "modal": True,
             "autowidth": True,
    ...
    if mode == "raw":
        entries += [
            {"name": "savefs",
             ...
             "url": reverse("modoboa_sievefilters:fs_save",
                            args=[setname])},
        ]
    ...
    entries += [
        {"name": "activatefs",
         ...
         "url": reverse("modoboa_sievefilters:fs_activate",
                        args=[setname])},
        {"name": "removefs",
         "img": "fa fa-trash",
         "label": _("Remove filters set"),
         "url": reverse("modoboa_sievefilters:fs_delete", args=[setname])},
        {"name": "downloadfs",
         "img": "fa fa-download",
         "label": _("Download"),
         "url": reverse("modoboa_sievefilters:fs_download", args=[setname])}
    ]
